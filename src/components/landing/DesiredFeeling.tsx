...
import { desiredFeelings } from '@/lib/const';
import { Button } from '@/components/ui/button';

export function DesiredFeeling({
  query,
  setQuery,
}: {
  query: RecipeConfig;
